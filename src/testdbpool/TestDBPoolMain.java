...
public class TestDBPoolMain {

    // 数据库驱动名称
    static String driver = "com.mysql.jdbc.Driver";

    // 数据库连接地址
    static String jdbcUrl = "jdbc:mysql://localhost:3306/crawl_india";
...
//        }
        ...
        // 输出结束时间
        System.out.println("c3p0 cost::"+(endMillis - startMillis));
    }
...
//        }
        ...
        long endMillis = System.currentTimeMillis();
        // 输出结束时间
        System.out.println("proxxool cost::"+(endMillis - startMillis));
    }
...
//        }
        ...
        long endMillis = System.currentTimeMillis();
        // 输出结束时间
        System.out.println("druid cost::"+(endMillis - startMillis));
    }
...
//        }
        ...
        long endMillis = System.currentTimeMillis();
        // 输出结束时间
        System.out.println("tomcat cost::"+(endMillis - startMillis));
    }
